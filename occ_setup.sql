...
(   'FGHPC','01PNTBNG_U01,01PNTBNG_U02','OCC',30,'OFFERED_CAPACITY = 0 AND IDR < 10 AND HAS_OUTAGE = 0','Usual','RESOURCE CONSTRAINTS-HYDRO','Water Level and Irrigation Diversion Requirement Constraint. Please refer to items C.1, C.2, C.3 of the submitted affidavit.
 ...
 No generation on PHEPP due to inability of MHEPP to generate brought by very low IDR and water discharge. Please refer to the attached DOR for IDR, and Pantabangan & Masiway dam elevation.','FGHPC_OCC_[DATE].zip'),
...
Section 3.1.  PHEPP cannot operate at 120MW if the level of the water at the Pantabangan reservoir is below two hundred seven (207) meters above sea level.','FGHPC_OCC_[DATE].zip'),
...
(   'FGHPC','01MASIWA_G01','OCC',20,'OFFERED_CAPACITY = 0 AND IDR = 0 AND HAS_OUTAGE = 0','Usual','RESOURCE CONSTRAINTS-HYDRO','Water Level and Irrigation Diversion Requirement Constraint. Please refer to items C.1, C.2, C.3 of the submitted affidavit.
 ...
 Zero Irrigation Diversion Requirement (IDR) and water discharge. The dispatch of MHEPP is highly dependent on the IDR and water discharge, water flow through the turbines and the water level at the Masiway reservoir. Please refer to the attached DOR for the IDR and Masiway dam elevation.','FGHPC_OCC_[DATE].zip'),
...
TRUNCATE TABLE OCC_DATA;

INSERT INTO OCC_DATA
VALUES(10, 'CASECN_TEST', 'Scheduled', '2026-01-25 11:00', 1, 10, null, null, null, null, null, 'For Submission', 82.5, 60, null, null, null);
