...
package cpems_talend.memocode_iterate_date_ddmmmyyyy_tjava_1_code_0_1;
...
/**
 * Job: MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE Purpose: <br>
 * Description:  <br>
 * @author gprgonzalez@firstgen.com.ph
 * @version 8.0.1.20260211_0926-patch
 * @status 
 */
public class MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE implements TalendJob {
	static {System.setProperty("TalendJob.log", "MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE";
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TalendException)) {
			MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE.this.exception = e;
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
globalMap.put("file_date", TalendDate.formatDate("ddMMMyyyy", TalendDate.addDate(TalendDate.parseDate("yyyyMMdd", ((String)globalMap.get("StartDate"))), ((Integer)globalMap.get("tLoop_1_CURRENT_VALUE")), "dd")));



//System.out.println(((String)globalMap.get("file_date")));
 ...
 */
    ...
    public static void main(String[] args){
        final MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODEClass = new MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE();

        int exitCode = MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODEClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2026-03-09T06:09:38.045159700Z");
        ...
        try {
            ...
            java.io.InputStream inContext = MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE.class.getClassLoader().getResourceAsStream("cpems_talend/memocode_iterate_date_ddmmmyyyy_tjava_1_code_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",ResumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE");
        }
		if(enableLogStash) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'MemoCode_Iterate_Date_ddMMMyyyy_tJava_1_CODE' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     52267 characters generated by Talend Cloud Data Management Platform 
 *     on the 9 March 2026 at 2:09:38 pm CST
 ************************************************************************************************/